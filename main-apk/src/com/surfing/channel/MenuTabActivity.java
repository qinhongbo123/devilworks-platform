...
public class MenuTabActivity extends ActivityGroup
{
    ...
    R.string.inner_message, R.string.contact_title,
    /* R.string.vote_title, */
...
/*
    private void getUnreadNotifiction()
    {
        ...
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(MenuTabActivity.this).setTitle(R.string.message_title_indicate)
