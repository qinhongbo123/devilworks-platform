...
public class ServerListenerService extends Service
{
            ...
            try
            {
                ...
                if (channelInfo != null)
                {
                    ...
                    if (operationList.size() > 0)
                    {
                        ...
                        showNotification(R.drawable.notify_online, getResources().getString(R.string.notify_state_display), null, getResources().getString(R.string.notify_state_list_text));
                    }
    ...
    private void login()
    {
        ...
        String geturl = ReadConfigFile.getServerAddress(mContext) + "index.php" + "?" + "controller=user&action=PhoneLogin&username=" + user_name + "&password=" + user_passwad;
