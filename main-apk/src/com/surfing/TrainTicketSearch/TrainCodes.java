...
public class TrainCodes extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        TextView refreshTime_Label = (TextView) this
                .findViewById(R.id.refreshTime_Label1);
        ...
        this.setTitle(title);
        refreshTime_Label.setText("time:"
                + refreshTime);
        ...
        listItemAdapter = new SimpleAdapter(this, listItem,
                R.layout.traincodeslistitem, new String[] { "ItemTitle",
                        "Start_ArriveStation", "Start_ArriveTime" }, new int[] {
                        R.id.trainCodeItemTitle, R.id.start_arriveStation1,
        ...
        for (int i = 0; i < trainArray.size(); i++)
        {
            ...
            map.put("ItemTitle",
                    trainArray.get(i).getTrainCode().replace(">", ""));

            String Start_ArriveStation = " "
                    + trainArray.get(i).getStartStation() + "-"
                    + trainArray.get(i).getArriveStation();
            map.put("Start_ArriveStation", Start_ArriveStation);

            String itemText1 = trainArray.get(i).getStartTime() + trainArray.get(i).getArrtiveTime() 
        ...
        list.setOnItemClickListener(new OnItemClickListener()
        {
            ...
            {
                String trainCode = ((TextView) view
                        .findViewById(R.id.trainCodeItemTitle)).getText()
                        .toString().trim();
