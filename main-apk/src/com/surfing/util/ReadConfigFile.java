...
public class ReadConfigFile
{
    ...
    public static String getServerAddress(Context context)
    {
        ...
        try
        {
            ...
            String configPath = Environment.getExternalStorageDirectory() + "/DownFile/config.xml";
    ...
    {
        SharedPreferences pref = context.getSharedPreferences(segment, Context.MODE_PRIVATE);
